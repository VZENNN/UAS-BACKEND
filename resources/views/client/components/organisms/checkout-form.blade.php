<div class="container py-4">
    <form action="{{ route('clientCheckoutSave') }}" method="post">
        ...
        <div class="form-group">
            ...
            <textarea name="note" id="note" cols="30" class="form-control @error('note') is-invalid @enderror bg-transparent" placeholder="Tambahkan lebih banyak saus  . . .">{{ old('note') }}</textarea>
            @error('note')
